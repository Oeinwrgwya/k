const UPGRADES_R1={
  ...
  bow:[
    {id:'wide_bow',name:'Wide Bow',icon:'🏹',desc:'Fires 2.5x as fast, very weak knockback, no spread shots.',stats:[{t:'Fire rate ×2.5',g:true},{t:'Weak knockback',g:false},{t:'No triple shot',g:false}],fireRateMult:2.5,tripleShot:false,spreadAngles:[],weakKnockback:true},
